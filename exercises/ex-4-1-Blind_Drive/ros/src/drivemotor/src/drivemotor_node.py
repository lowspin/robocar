...
class MotorDriver():
  ...
  def loop(self):
    ...
    while not rospy.is_shutdown():
      ...
      ####################################################################3
      # TO-DO:
      # Write codes to control the motors using the motorHAT library,
      # using the latest values for self.left_wheel and self.right_wheel
      # Remember Motor Indexing:
      # left wheels = motors 1 and 3
      # right wheels = motors 2 and 4
      ####################################################################3
