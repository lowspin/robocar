...
#################################################
# TO-DO: 
# 1) fit a degree one (linear) polynomial with collected points
# 2) extract polynomial cooefficients into p, where p(x) = y (estimate)
# note: flip axis such that x is the vertical axis (+ve=down), 
#       and y is the horizontal axis (+ve=across)
#################################################
